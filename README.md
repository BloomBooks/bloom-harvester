...
## Development
Open a command window. Navigate to the build folder under the root. Run getDepencies-windows.sh. This will download some dependencies to lib/dotnet/&ast;.dll.
