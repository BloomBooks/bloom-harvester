...
namespace BloomHarvester
{
	...
	public class HarvesterOptions
	{
		...
		[Option("skipUploadDotBloom", Required = false, Default = false, HelpText = "If true, will prevent the .bloom artifact from being created and uploaded.")]
		public bool SkipUploadDotBloom { get; set; }
		...
		public virtual string GetPrettyPrint()
		{
			return $"mode: {Mode}\n" +
				...
				$"skipUploadDotBloom: {SkipUploadDotBloom}";
		}
