	...
	class HarvesterTests
	{
		...
		public void ProcessOneBook_MissingFont_UpdatesWhatItCanAnyway()
		{
			...
			using (var harvester = GetSubstituteHarvester(options, fontChecker: fakeFontChecker, fileIO:fakeFileIO, bookAnalyzer:fakeAnalyzer))
			{
				...
				var updateJson = "{\"harvestState\":\"Failed\",\"harvestLog\":[\"Error: MissingFont - madeUpFontName\"],\"phashOfFirstContentImage\":\"0123456789ABCDEF\",\"show\":{\"social\":{\"harvester\":true},\"epub\":{\"harvester\":false},\"bloomReader\":{\"harvester\":false},\"readOnline\":{\"harvester\":false}},\"updateSource\":\"bloomHarvester\"}";
