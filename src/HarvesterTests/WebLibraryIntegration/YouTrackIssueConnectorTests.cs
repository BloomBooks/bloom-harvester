...
namespace BloomHarvesterTests.WebLibraryIntegration
{
	...
	public class YouTrackIssueConnectorTests
	{
		...
		[OneTimeSetUp]
		public void InitializeYouTrack()
		{
			_connector = YouTrackIssueConnector.GetInstance(EnvironmentSetting.Test);
		}
		...
		public void TestReportException()
		{
			...
			Assert.That(report.ProjectKey, Is.EqualTo("BH"), "The standard Bloom Harvester project key is used for the report.");
