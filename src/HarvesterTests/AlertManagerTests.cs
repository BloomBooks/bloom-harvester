...
namespace BloomHarvesterTests
{
	...
	public class AlertManagerTests
	{
		...
		public void NewBookErrorsGetReportedOncePerBookOrMaxPerUploader()
		{
			...
			var model1 = JsonConvert.DeserializeObject<BookModel>("{'baseUrl':'first book url','title':'First Book','uploader':{'objectId':'uploader1'},'harvestState':'New'}");
			var model2 = JsonConvert.DeserializeObject<BookModel>("{'baseUrl':'second book url','title':'Second Book','uploader':{'objectId':'uploader1'},'harvestState':'New'}");
			var model3 = JsonConvert.DeserializeObject<BookModel>("{'baseUrl':'third book url','title':'Third Book','uploader':{'objectId':'uploader1'},'harvestState':'New'}");
			var model4 = JsonConvert.DeserializeObject<BookModel>("{'baseUrl':'fourth book url','title':'Fourth Book','uploader':{'objectId':'uploader1'},'harvestState':'New'}");
			var model5 = JsonConvert.DeserializeObject<BookModel>("{'baseUrl':'fifth book url','title':'Fifth Book','uploader':{'objectId':'uploader1'},'harvestState':'New'}");
			var model6 = JsonConvert.DeserializeObject<BookModel>("{'baseUrl':'sixth book url','title':'Sixth Book','uploader':{'objectId':'uploader1'},'harvestState':'New'}");
			var model7 = JsonConvert.DeserializeObject<BookModel>("{'baseUrl':'seventh book url','title':'Seventh Book','uploader':{'objectId':'uploader2'},'harvestState':'New'}");
			var model8 = JsonConvert.DeserializeObject<BookModel>("{'baseUrl':'eighth book url','title':'Eighth Book','uploader':{'objectId':'uploader2'},'harvestState':'New'}");
